...
function Login(){
    ...
    return (
        <div className={""}>
            ...
            <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-slate-900">
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                <a href="#" class="flex">
                <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Blogging Website</span>
                </a>
                <div class="flex md:order-2">
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Please login</button>
            ...
            <section class="flex justify-center h-screen items-center bg-gray-100 h-fullwidth">
                <div class="max-w-md w-full bg-white rounded p-6 space-y-4">
                    ...
                    <div>
                        <input id={"name"} class="w-full p-4 text-sm bg-gray-50 focus:outline-none border border-gray-200 rounded text-gray-600" type="text" placeholder="username" />
                    </div>
                    <div>
                    ...
                    <div>
                        <button class="w-full py-4 bg-blue-600 hover:bg-blue-700 rounded text-sm font-bold text-gray-50 transition duration-200" onClick={loginfn}>Sign In</button>
                    </div>
