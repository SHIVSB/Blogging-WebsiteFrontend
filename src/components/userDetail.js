...
function Details(){
    ...
    return (
        <div>
            ...
            <div className={"text-center mx-24 sm:mx-32 md:mx-48 my-12 lg:mx-96 border-2 border-black rounded-lg bg-slate-300"}>
                <h1 className={"text-4xl font-bold my-16"}>User Details</h1>
                <h2 className={"text-4xl font-bold mb-12"}>Name : <span className={"font-semibold uppercase"}>{name}</span></h2>
            </div>
        </div>            
    );
}
